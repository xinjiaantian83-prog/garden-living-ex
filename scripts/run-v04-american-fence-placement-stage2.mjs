...
const OUTPUT_DIR = resolve(PROJECT_ROOT, 'generated/v04-american-fence-placement-stage2');
...
const placementExamples = [
  {
    product_id: 'AMERICAN-FENCE-PLACEMENT-BUILDING-EDGE-GATE',
    product_name: '施工事例: 建物際とゲート付き配置',
    category: 'アメリカンフェンス施工事例',
    image_url: 'images/g20-material/american-fence-placement-reference/american-fence-building-edge-gate.webp',
  },
  {
    product_id: 'AMERICAN-FENCE-PLACEMENT-DOG-GATE',
    product_name: '施工事例: ドッグランの出入口',
    category: 'アメリカンフェンス施工事例',
    image_url: 'images/g20-material/american-fence-placement-reference/american-fence-dog-gate.jpg',
  },
  {
    product_id: 'AMERICAN-FENCE-PLACEMENT-BUILDING-LINE',
    product_name: '施工事例: 建物際の直線配置',
    category: 'アメリカンフェンス施工事例',
    image_url: 'images/g20-material/american-fence-placement-reference/american-fence-building-line.jpg',
  },
  {
    product_id: 'AMERICAN-FENCE-PLACEMENT-U-SHAPE-DIAGRAM',
    product_name: '施工事例: コの字配置と片開き扉',
    category: 'アメリカンフェンス施工事例',
    image_url: 'images/g20-material/american-fence-placement-reference/american-fence-u-shape-diagram.jpg',
  },
  {
    product_id: 'AMERICAN-FENCE-PLACEMENT-DOGRUN-ENCLOSURE',
    product_name: '施工事例: ドッグランを囲う配置',
    category: 'アメリカンフェンス施工事例',
    image_url: 'images/g20-material/american-fence-placement-reference/american-fence-dogrun-enclosure.jpg',
  },
];
...
function buildPayload(sourcePath) {
  return {
    ...
    reference_products: [americanFenceReference, ...placementExamples],
  };
}
...
async function main() {
  ...
  const log = {
    version: '0.4-stage2',
    purpose: 'American fence placement tendency with construction example references. No placement rules added.',
    source_image: sourcePath,
    product: americanFenceReference,
    placement_examples: placementExamples,
    run_count: RUN_COUNT,
  ...
  for (let index = 1; index <= RUN_COUNT; index += 1) {
    ...
    const outputName = `american-fence-stage2-${String(index).padStart(2, '0')}.png`;
